...
* **`pipelines/`**: Contiene el Cuaderno Jupyter maestro parametrizado (`3_modelado_evaluacion.ipynb`) que utiliza Papermill como plantilla para ejecutar los reentrenamientos de forma automatizada.
